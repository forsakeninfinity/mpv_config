...
leadin = 1.25            --seconds to stop short of the next subtitle
skipmode = true        --instead of speeding up playback seek to the next known subtitle
maxSkip = 240            --max seek distance (seconds) when skipmode is enabled
